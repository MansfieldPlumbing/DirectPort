...
def main():
    """
    A D3D12 multiplexer that discovers all DirectPort producers,
    composites them into a grid, and broadcasts the result.
    """
    print("--- DirectPort D3D12 Multiplexer ---")
    ...
    window_title = "D3D12 Multiplexer"
    ...
    producer = device.create_producer("directport_mux_d3d12", shared_out_texture)
