...
def main():
    """
    A D3D11 Python producer that renders a dynamically loaded shader 
    and shares it via DirectPort.
    """
    print("--- DirectPort D3D11 Shader Producer ---")
    ...
    window = device.create_window(RENDER_WIDTH, RENDER_HEIGHT, "D3D11 Shader Producer - No Shader Loaded")
    ...
    producer = device.create_producer("directport_py_shader_d3d11", shader_texture)
    ...
    try:
        ...
        while window.process_events():
            ...
            if app_state["shader_dirty"]:
                ...
                window.set_title(f"D3D11 Shader Producer - Loaded: {app_state['shader_path']}")
